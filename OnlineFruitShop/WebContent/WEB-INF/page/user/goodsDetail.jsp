...
<body class="wrapper">
	...
	<div class="header">
		...
		<div class="tools">
			<input type="text" value="" /> <span> <i>搜索</i>
			</span>
		</div>
	</div>
	<div class="main">
		<div class="detail" style="margin-top:2%;">
			...
			<div class="info">
				...
				<h4 style="color:red;line-height:0;"><%=goods.getIntroduction() %></h4>
				<div class="price">
					<font>促销价</font> <span>￥<%=goods.getPrice() %></span>
				</div>
				<div class="stock">
					<font>库&nbsp;存</font> <span><%=goods.getStock() %></span>
				</div>
				<div class="buyCount">
					<font>数&nbsp;量</font> <span> <font id="minus">-</font> <input
						class="pull-left" id="count" type="tel" value="1"
						disabled="disabled"> <font id="plus">+</font>
					</span>
				</div>
				<div class="totalPrice">
					<font>总&nbsp;价</font> <span> ￥<%=goods.getPrice() %></span>
				</div>
				<div class="">
					<input type="hidden" id="gid" value="<%=goods.getId() %>"> <input
		...
		<div class="comment">
			<div class="title">
				<span>商品简介</span> <span>顾客评论(10)</span>
			</div>
			<div class="content" style="display: none;">
				<ul style="margin-left: -2%;">
					<li style="border-bottom: 1px #808080 solid;">
						...
						<div class="right">
							<p
								style="max-height: 72px; overflow: hidden; word-wrap: break-word;">内容
								:尺码标准，面料柔软穿着舒服，版型修身，做工精细，适合初秋穿，吊牌是柒牌！</p>
			...
			<%for(String detailImage : goods.getImageList().split(";")) { %>
				<img src="<%=request.getContextPath()%>/<%=detailImage%>" style="margin-left:20%"> <br />
				<br />
			<%} %>
		</div>
	</div>
	<div style="margin-top:1%; margin-bottom:2%;">
		...
		<div style="font-size: x-small; text-align:center;">
			<b>© 2003-2017 HENU.COM 版权所有</b>
		</div>
	</div>
	<script src="<%=request.getContextPath()%>/static/js/vue.js"></script>
